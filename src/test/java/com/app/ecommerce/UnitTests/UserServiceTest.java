...
import com.app.ecommerce.services.TokenService;
...
class UserServiceTest {
    ...
    void register() {
        ...
        Assertions.assertEquals(registerRequest.username(),response.username());
    }
    ...
    void registerAdmin() {
        ...
        Assertions.assertEquals(admin.getUsername(),response.username());
    }
    ...
    void updateException() {
        ...
        Assertions.assertThrows(ResponseStatusException.class,()-> userService.update(user.getId(), registerRequest));
    }
}