...
public interface Product {
    ...
    @PostMapping()
    ResponseEntity<com.app.labdesoftware.entities.Product> create(@RequestBody ProductRequest productRequest);
    ...
    @PutMapping("/{id}")
    ResponseEntity<com.app.labdesoftware.entities.Product> update(@PathVariable("id") Integer id, @RequestBody ProductRequest productRequest);
    ...
    @DeleteMapping("/{id}")
    ResponseEntity<com.app.labdesoftware.entities.Product> delete(@PathVariable("id") Integer id);
}
