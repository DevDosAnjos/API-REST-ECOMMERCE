...
public interface User {
    ...
    @GetMapping("/all")
    ResponseEntity<List<UserResponse>> listAll(@AuthenticationPrincipal com.app.ecommerce.entities.User user);
    ...
    @GetMapping("/admins")
    ResponseEntity<List<UserResponse>> listAllAdmins(@AuthenticationPrincipal com.app.ecommerce.entities.User user);
    ...
    @GetMapping("/users")
    ResponseEntity<List<UserResponse>> listAllUsers(@AuthenticationPrincipal com.app.ecommerce.entities.User user);
    ...
    @PutMapping()
    ResponseEntity<UpdateRegisterResponse> update(@AuthenticationPrincipal com.app.ecommerce.entities.User user, @RequestBody RegisterRequest registerRequest);
}
