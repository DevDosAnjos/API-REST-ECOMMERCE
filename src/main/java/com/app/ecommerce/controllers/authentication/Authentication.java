...
public interface Authentication {
    ...
    ResponseEntity<RegisterResponse> registerAdmin(@AuthenticationPrincipal com.app.ecommerce.entities.User user, @RequestBody RegisterRequest registerRequest);
}
