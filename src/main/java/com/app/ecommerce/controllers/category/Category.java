...
public interface Category {
    ...
    @PostMapping()
    ResponseEntity<com.app.ecommerce.entities.Category> create(@RequestBody CategoryRequest categoryRequest);
    ...
    @PutMapping("/{id}")
    ResponseEntity<com.app.ecommerce.entities.Category> update(@PathVariable("id") Integer id, @RequestBody CategoryRequest categoryRequest);
    ...
    @DeleteMapping("/{id}")
    ResponseEntity<com.app.ecommerce.entities.Category> delete(@PathVariable("id") Integer id);
